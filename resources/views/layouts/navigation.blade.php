            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        <img src="{{ asset('favicon.png') }}" alt="Virginia Cybercon logo" class="h-9 w-9 object-contain" />
                        <span class="text-sm font-bold tracking-wide text-gray-800">{{ config('app.name', 'Virginia Cybercon') }}</span>
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('admin.speakers.index')" :active="request()->routeIs('admin.speakers.*')">
                        {{ __('Speakers') }}
                    </x-nav-link>
